...
var G__6266 = o;
goog.object.set(G__6266,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__6268__i = 0, G__6268__a = new Array(arguments.length -  0);
while (G__6268__i < G__6268__a.length) {G__6268__a[G__6268__i] = arguments[G__6268__i + 0]; ++G__6268__i;}
  args = new cljs.core.IndexedSeq(G__6268__a,0,null);
} 
...
var G__6270 = o;
goog.object.set(G__6270,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__6272__i < G__6272__a.length) {G__6272__a[G__6272__i] = arguments[G__6272__i + 0]; ++G__6272__i;}
  args = new cljs.core.IndexedSeq(G__6272__a,0,null);
} 
...
var G__6274 = props;
var G__6274__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__6274,cljs.core.cst$kw$id,id):G__6274);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__6274__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__6274__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__6275 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__6275,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__6275;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__6276){
var map__6277 = p__6276;
var map__6277__$1 = (((((!((map__6277 == null))))?(((((map__6277.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__6277.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__6277):map__6277);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6277__$1,cljs.core.cst$kw$on_DASH_write);
...
return (jsprops.onChange = (function (p1__6279_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__6279_SHARP_);
}));
} else {
return null;
}
...
var vec__6282 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6282,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6282,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6282,(2),null);
...
var temp__5739__auto___6286 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___6286 == null)){
} else {
var key_6287 = temp__5739__auto___6286;
(jsprops.key = key_6287);
}
...
var temp__5739__auto___6288 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___6288 == null)){
} else {
var key_6289 = temp__5739__auto___6288;
(jsprops.key = key_6289);
}
...
var G__6290 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__6290) : reagent.impl.template.as_element.call(null,G__6290));
} else {
var temp__5739__auto___6291 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___6291 == null)){
} else {
var key_6292 = temp__5739__auto___6291;
(jsprops.key = key_6292);
}
...
var G__6294 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__6294)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__6294)){
return x;
} else {
...
var len__4736__auto___6297 = arguments.length;
var i__4737__auto___6298 = (0);
while(true){
if((i__4737__auto___6298 < len__4736__auto___6297)){
args__4742__auto__.push((arguments[i__4737__auto___6298]));

var G__6299 = (i__4737__auto___6298 + (1));
i__4737__auto___6298 = G__6299;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq6295){
var G__6296 = cljs.core.first(seq6295);
var seq6295__$1 = cljs.core.next(seq6295);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__6296,seq6295__$1);
}));
...
break;
default:
var G__6302 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__6302;
continue;
...
var ctx = ({});
var vec__6304 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6304,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6304,(1),null);
...
var G__6307 = (cljs.core.count(argv) - first_child);
switch (G__6307) {
case (0):
...
break;
case (1):
var G__6308 = component;
var G__6309 = jsprops;
var G__6310 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.global$module$react.createElement(G__6308,G__6309,G__6310);
