...
var G__38885 = o;
goog.object.set(G__38885,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__38886__delegate = function (args){
...
while (G__38887__i < G__38887__a.length) {G__38887__a[G__38887__i] = arguments[G__38887__i + 0]; ++G__38887__i;}
  args = new cljs.core.IndexedSeq(G__38887__a,0,null);
} 
return G__38886__delegate.call(this,args);};
G__38886.cljs$lang$maxFixedArity = 0;
G__38886.cljs$lang$applyTo = (function (arglist__38888){
var args = cljs.core.seq(arglist__38888);
return G__38886__delegate(args);
});
...
var G__38889 = o;
goog.object.set(G__38889,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__38891__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__38891 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__38892__i = 0, G__38892__a = new Array(arguments.length -  0);
while (G__38892__i < G__38892__a.length) {G__38892__a[G__38892__i] = arguments[G__38892__i + 0]; ++G__38892__i;}
  args = new cljs.core.IndexedSeq(G__38892__a,0,null);
} 
return G__38891__delegate.call(this,args);};
G__38891.cljs$lang$maxFixedArity = 0;
G__38891.cljs$lang$applyTo = (function (arglist__38893){
var args = cljs.core.seq(arglist__38893);
return G__38891__delegate(args);
});
...
var G__38894 = props;
var G__38894__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__38894,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__38894);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__38894__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__38894__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__38895 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__38895,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__38895;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__38896){
...
var on_write = cljs.core.get.call(null,map__38897__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__38899_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__38899_SHARP_);
}));
} else {
return null;
}
...
var vec__38902 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__38902,(0),null);
var id = cljs.core.nth.call(null,vec__38902,(1),null);
var className = cljs.core.nth.call(null,vec__38902,(2),null);
...
var temp__5739__auto___38906 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5739__auto___38906 == null)){
} else {
var key_38907 = temp__5739__auto___38906;
(jsprops.key = key_38907);
}
...
var temp__5739__auto___38908 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5739__auto___38908 == null)){
} else {
var key_38909 = temp__5739__auto___38908;
(jsprops.key = key_38909);
}
...
var temp__5739__auto___38910 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___38910 == null)){
} else {
var key_38911 = temp__5739__auto___38910;
(jsprops.key = key_38911);
}
...
var G__38913 = n;
if(cljs.core._EQ_.call(null,"",G__38913)){
return x;
} else {
if(cljs.core._EQ_.call(null,null,G__38913)){
return x;
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq38914){
var G__38915 = cljs.core.first.call(null,seq38914);
var seq38914__$1 = cljs.core.next.call(null,seq38914);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38915,seq38914__$1);
}));
...
break;
default:
var G__38921 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__38921;
continue;
...
var ctx = ({});
var vec__38923 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
}));
var res = cljs.core.nth.call(null,vec__38923,(0),null);
var derefed = cljs.core.nth.call(null,vec__38923,(1),null);
...
var G__38926 = (cljs.core.count.call(null,argv) - first_child);
switch (G__38926) {
case (0):
...
//# sourceMappingURL=template.js.map?rel=1618065937581
