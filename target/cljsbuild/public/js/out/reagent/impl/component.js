...
if((i < len)){
var k = (ks[i]);
var G__38859 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),goog.object.get(o,k));
var G__38860 = (i + (1));
m = G__38859;
i = G__38860;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__38862 = c;
var G__38862__$1 = (((G__38862 == null))?null:G__38862.prototype);
if((G__38862__$1 == null)){
return null;
} else {
return G__38862__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__38864 = c;
var G__38864__$1 = (((G__38864 == null))?null:G__38864.prototype);
if((G__38864__$1 == null)){
return null;
} else {
return G__38864__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__38867__delegate = function (args){
...
while (G__38868__i < G__38868__a.length) {G__38868__a[G__38868__i] = arguments[G__38868__i + 0]; ++G__38868__i;}
  args = new cljs.core.IndexedSeq(G__38868__a,0,null);
} 
return G__38867__delegate.call(this,args);};
G__38867.cljs$lang$maxFixedArity = 0;
G__38867.cljs$lang$applyTo = (function (arglist__38869){
var args = cljs.core.seq(arglist__38869);
return G__38867__delegate(args);
});
...
var G__38871 = c;
var G__38871__$1 = (((G__38871 == null))?null:G__38871.constructor);
if((G__38871__$1 == null)){
return null;
} else {
return G__38871__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__38872 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__38873 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__38873);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__38872);
}});
...
var c = this;
var G__38877_38879 = goog.object.get(c,"cljsRatom");
if((G__38877_38879 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__38877_38879);
}
...
var renders_38880 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_38881 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_38880));
...
if((cljs.core.count.call(null,renders_38880) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_38880))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_38881)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.call(null,render_fun_38881)].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__38882 = o;
goog.object.set(G__38882,cljs.core.name.call(null,k),v);
...
//# sourceMappingURL=component.js.map?rel=1618065937463
