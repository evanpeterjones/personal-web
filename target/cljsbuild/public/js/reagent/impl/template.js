...
var G__10016 = o;
goog.object.set(G__10016,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__10020 = o;
goog.object.set(G__10020,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__10022__i < G__10022__a.length) {G__10022__a[G__10022__i] = arguments[G__10022__i + 0]; ++G__10022__i;}
  args = new cljs.core.IndexedSeq(G__10022__a,0,null);
} 
...
var G__10024 = props;
var G__10024__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10024,cljs.core.cst$kw$id,id):G__10024);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10024__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__10024__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__10025 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10025,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__10025;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__10026){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10027__$1,cljs.core.cst$kw$on_DASH_write);
...
return (jsprops.onChange = (function (p1__10029_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__10029_SHARP_);
}));
} else {
return null;
}
...
var vec__10032 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10032,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10032,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10032,(2),null);
...
var temp__5739__auto___10036 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___10036 == null)){
} else {
var key_10037 = temp__5739__auto___10036;
(jsprops.key = key_10037);
}
...
var temp__5739__auto___10038 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___10038 == null)){
} else {
var key_10039 = temp__5739__auto___10038;
(jsprops.key = key_10039);
}
...
var G__10040 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__10040) : reagent.impl.template.as_element.call(null,G__10040));
} else {
var temp__5739__auto___10041 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___10041 == null)){
} else {
var key_10042 = temp__5739__auto___10041;
(jsprops.key = key_10042);
}
...
var G__10044 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__10044)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__10044)){
return x;
} else {
...
var len__4736__auto___10047 = arguments.length;
var i__4737__auto___10048 = (0);
while(true){
if((i__4737__auto___10048 < len__4736__auto___10047)){
args__4742__auto__.push((arguments[i__4737__auto___10048]));

var G__10049 = (i__4737__auto___10048 + (1));
i__4737__auto___10048 = G__10049;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq10045){
var G__10046 = cljs.core.first(seq10045);
var seq10045__$1 = cljs.core.next(seq10045);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10046,seq10045__$1);
}));
...
break;
default:
var G__10052 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__10052;
continue;
...
var ctx = ({});
var vec__10054 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10054,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10054,(1),null);
...
var G__10057 = (cljs.core.count(argv) - first_child);
switch (G__10057) {
case (0):
...
break;
case (1):
var G__10058 = component;
var G__10059 = jsprops;
var G__10060 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.global$module$react.createElement(G__10058,G__10059,G__10060);
