...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__7011 = cljs.core.second(format);
var G__7012 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__7011,G__7012) : ajax.easy.keyword_response_format_element.call(null,G__7011,G__7012));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
var G__7013 = format;
var G__7013__$1 = (((G__7013 instanceof cljs.core.Keyword))?G__7013.fqn:null);
switch (G__7013__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__7015_SHARP_){
return ajax.easy.keyword_response_format_element(p1__7015_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__7016){
var map__7017 = p__7016;
var map__7017__$1 = (((((!((map__7017 == null))))?(((((map__7017.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__7017.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__7017):map__7017);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7017__$1,cljs.core.cst$kw$handler);
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7017__$1,cljs.core.cst$kw$error_DASH_handler);
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7017__$1,cljs.core.cst$kw$finally);
...
return (function ajax$easy$transform_handler_$_easy_handler(p__7019){
var vec__7020 = p__7019;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7020,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7020,(1),null);
var fexpr__7023_7024 = (cljs.core.truth_(ok)?h:e);
(fexpr__7023_7024.cljs$core$IFn$_invoke$arity$1 ? fexpr__7023_7024.cljs$core$IFn$_invoke$arity$1(result) : fexpr__7023_7024.call(null,result));
...
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__7025){
...
var opts = map__7026__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7026__$1,cljs.core.cst$kw$method);
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7026__$1,cljs.core.cst$kw$format);
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7026__$1,cljs.core.cst$kw$response_DASH_format);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7026__$1,cljs.core.cst$kw$params);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7026__$1,cljs.core.cst$kw$body);
