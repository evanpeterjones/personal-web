...
var o33322 = temp__5733__auto__;
var temp__5733__auto____$1 = (o33322["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o33323 = temp__5733__auto____$1;
return (o33323["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__32680__auto__ = f;
return (o__32680__auto__["toString"]).call(o__32680__auto__);
} else {
return "";
}
}catch (e33324){var _ = e33324;
return "";
}});
...
try{var o__32680__auto___33326 = t;
(o__32680__auto___33326["cljs$lang$ctorPrWriter"]).call(o__32680__auto___33326,t,writer);
}catch (e33325){var __33327 = e33325;
}
...
var char_code = (function (){var o__32680__auto__ = (new String(char$));
return (o__32680__auto__["charCodeAt"]).call(o__32680__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__32680__auto__ = String;
return (o__32680__auto__["fromCharCode"]).call(o__32680__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__33328 = num_code;
switch (G__33328) {
case (1):
return (185);
...
var o__32680__auto__ = String;
return (o__32680__auto__["fromCharCode"]).call(o__32680__auto__,superscript_code);
});
/**
...
}catch (e33330){var _e__32687__auto__ = e33330;
return false;
}})())){
...
var vec__33331 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__33331,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__33336){
var vec__33337 = p__33336;
var ns_detector = cljs.core.nth.call(null,vec__33337,(0),null);
...
var G__33343 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__33344 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__33343;
remaining_tokens = G__33344;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq33334){
var G__33335 = cljs.core.first.call(null,seq33334);
var seq33334__$1 = cljs.core.next.call(null,seq33334);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33335,seq33334__$1);
}));
...
var vec__33348 = cljs.core.split_with.call(null,(function (p1__33347_SHARP_){
return cljs.core.not_EQ_.call(null,p1__33347_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__33348,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__33348,(1),null);
...
var vec__33354 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__33354,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__33354,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__33357 = cljs.core.rest.call(null,remaining_tokens);
var G__33358 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__33357;
name_tokens = G__33358;
continue;
} else {
...
var vec__33361 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__33361,(0),null);
var arity = cljs.core.nth.call(null,vec__33361,(1),null);
var vec__33364 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__33364,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__33364,(1),null);
var vec__33367 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__33367,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__33367,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__33367,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__33367,(3),null);
...
var vec__33373 = result;
var munged_ns = cljs.core.nth.call(null,vec__33373,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__33373,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__33373,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__33373,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__33373,(4),null);
var arity = cljs.core.nth.call(null,vec__33373,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__33377 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__33377,(0),null);
var args = cljs.core.nth.call(null,vec__33377,(1),null);
var vec__33380 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__33380,(0),null);
var name = cljs.core.nth.call(null,vec__33380,(1),null);
...
var G__33383 = (arity + (1));
var G__33384 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__33385){
var vec__33386 = p__33385;
var arity = cljs.core.nth.call(null,vec__33386,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__33386,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__33389_SHARP_){
return cljs.core.get.call(null,arities,p1__33389_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__33390_SHARP_){
return cljs.core.drop.call(null,(2),p1__33390_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__33393){
var vec__33394 = p__33393;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__33394,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq33391){
var G__33392 = cljs.core.first.call(null,seq33391);
var seq33391__$1 = cljs.core.next.call(null,seq33391);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33392,seq33391__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__33402__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__33402__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__33402__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__33402__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__33403 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__33403,(0),null);
var fn_name = cljs.core.nth.call(null,vec__33403,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__33403,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__33403,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__33403,(4),null);
var arity = cljs.core.nth.call(null,vec__33403,(5),null);
...
var o__32680__auto__ = f;
return (o__32680__auto__["getBasis"]).call(o__32680__auto__);
});
/**
...
}catch (e33407){var _e__32687__auto__ = e33407;
...
var G__33408 = (obj[cljs.core.first.call(null,path)]);
var G__33409 = cljs.core.rest.call(null,path);
obj = G__33408;
path = G__33409;
continue;
} else {
...
var _STAR_ = (function (accum,p__33410){
var vec__33411 = p__33410;
var bit = cljs.core.nth.call(null,vec__33411,(0),null);
var protocol = cljs.core.nth.call(null,vec__33411,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__33414){
var vec__33415 = p__33414;
var ns = cljs.core.nth.call(null,vec__33415,(0),null);
var name = cljs.core.nth.call(null,vec__33415,(1),null);
var selector = cljs.core.nth.call(null,vec__33415,(2),null);
...
var post_process = (function (p__33419){
var vec__33420 = p__33419;
var munged_name = cljs.core.nth.call(null,vec__33420,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__33420,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__33418_SHARP_){
return (obj[cljs.core.first.call(null,p1__33418_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1618065933451
