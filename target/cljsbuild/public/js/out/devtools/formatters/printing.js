...
var G__32981 = (i__4737__auto___32980 + (1));
i__4737__auto___32980 = G__32981;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq32976){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32977,G__32978,seq32976__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__32982_SHARP_){
return (!((cljs.core.meta.call(null,p1__32982_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__32983__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e32987){var _e__32212__auto__ = e32987;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e32989){var _e__32212__auto__ = e32989;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__32991 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__32992 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__32992);

try{var map__32993 = opts;
...
var markup_db = cljs.core.get.call(null,map__32993__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__32991);
}});
...
var temp__5733__auto___32998 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5733__auto___32998)){
var managed_print_level_32999 = temp__5733__auto___32998;
var _STAR_print_level_STAR__orig_val__32996_33000 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__32997_33001 = managed_print_level_32999;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__32997_33001);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__32995_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__32995_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__32996_33000);
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1617925391787
