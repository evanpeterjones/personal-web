(defproject cljs-personal-web "0.1.0-SNAPSHOT"
  ...
  :ring {:handler cljs-personal-web.handler/app
         :uberwar-name "cljs-personal-web.war"}

  :min-lein-version "2.5.0"
  :uberjar-name "cljs-personal-web.jar"
  :main cljs-personal-web.server
  ...
  {:builds {:min
            ...
            {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
             :figwheel {:on-jsload "cljs-personal-web.core/mount-root"}
             :compiler
             {:main "cljs-personal-web.dev"
              :asset-path "/js/out"
              :output-to "target/cljsbuild/public/js/app.js"
