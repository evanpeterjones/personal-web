...
var o32847 = temp__5733__auto__;
var temp__5733__auto____$1 = (o32847["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o32848 = temp__5733__auto____$1;
return (o32848["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__32205__auto__ = f;
return (o__32205__auto__["toString"]).call(o__32205__auto__);
} else {
return "";
}
}catch (e32849){var _ = e32849;
return "";
}});
...
try{var o__32205__auto___32851 = t;
(o__32205__auto___32851["cljs$lang$ctorPrWriter"]).call(o__32205__auto___32851,t,writer);
}catch (e32850){var __32852 = e32850;
}
...
var char_code = (function (){var o__32205__auto__ = (new String(char$));
return (o__32205__auto__["charCodeAt"]).call(o__32205__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__32205__auto__ = String;
return (o__32205__auto__["fromCharCode"]).call(o__32205__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__32853 = num_code;
switch (G__32853) {
case (1):
return (185);
...
var o__32205__auto__ = String;
return (o__32205__auto__["fromCharCode"]).call(o__32205__auto__,superscript_code);
});
/**
...
}catch (e32855){var _e__32212__auto__ = e32855;
return false;
}})())){
...
var vec__32856 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__32856,(0),null);
...
var len__4736__auto___32865 = arguments.length;
var i__4737__auto___32866 = (0);
while(true){
if((i__4737__auto___32866 < len__4736__auto___32865)){
args__4742__auto__.push((arguments[i__4737__auto___32866]));

var G__32867 = (i__4737__auto___32866 + (1));
i__4737__auto___32866 = G__32867;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__32861){
var vec__32862 = p__32861;
var ns_detector = cljs.core.nth.call(null,vec__32862,(0),null);
...
var G__32868 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__32869 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__32868;
remaining_tokens = G__32869;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq32859){
var G__32860 = cljs.core.first.call(null,seq32859);
var seq32859__$1 = cljs.core.next.call(null,seq32859);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32860,seq32859__$1);
}));
...
var vec__32873 = cljs.core.split_with.call(null,(function (p1__32872_SHARP_){
return cljs.core.not_EQ_.call(null,p1__32872_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__32873,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__32873,(1),null);
...
var vec__32879 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__32879,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__32879,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__32882 = cljs.core.rest.call(null,remaining_tokens);
var G__32883 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__32882;
name_tokens = G__32883;
continue;
} else {
...
var vec__32886 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__32886,(0),null);
var arity = cljs.core.nth.call(null,vec__32886,(1),null);
var vec__32889 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__32889,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__32889,(1),null);
var vec__32892 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__32892,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__32892,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__32892,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__32892,(3),null);
...
var vec__32898 = result;
var munged_ns = cljs.core.nth.call(null,vec__32898,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__32898,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__32898,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__32898,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__32898,(4),null);
var arity = cljs.core.nth.call(null,vec__32898,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__32902 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__32902,(0),null);
var args = cljs.core.nth.call(null,vec__32902,(1),null);
var vec__32905 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__32905,(0),null);
var name = cljs.core.nth.call(null,vec__32905,(1),null);
...
var G__32908 = (arity + (1));
var G__32909 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__32910){
var vec__32911 = p__32910;
var arity = cljs.core.nth.call(null,vec__32911,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__32911,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__32914_SHARP_){
return cljs.core.get.call(null,arities,p1__32914_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__32915_SHARP_){
return cljs.core.drop.call(null,(2),p1__32915_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___32922 = arguments.length;
var i__4737__auto___32923 = (0);
while(true){
if((i__4737__auto___32923 < len__4736__auto___32922)){
args__4742__auto__.push((arguments[i__4737__auto___32923]));

var G__32924 = (i__4737__auto___32923 + (1));
i__4737__auto___32923 = G__32924;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__32918){
var vec__32919 = p__32918;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__32919,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq32916){
var G__32917 = cljs.core.first.call(null,seq32916);
var seq32916__$1 = cljs.core.next.call(null,seq32916);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32917,seq32916__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__32927__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__32927__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__32927__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__32927__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__32928 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__32928,(0),null);
var fn_name = cljs.core.nth.call(null,vec__32928,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__32928,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__32928,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__32928,(4),null);
var arity = cljs.core.nth.call(null,vec__32928,(5),null);
...
var o__32205__auto__ = f;
return (o__32205__auto__["getBasis"]).call(o__32205__auto__);
});
/**
...
}catch (e32932){var _e__32212__auto__ = e32932;
...
var G__32933 = (obj[cljs.core.first.call(null,path)]);
var G__32934 = cljs.core.rest.call(null,path);
obj = G__32933;
path = G__32934;
continue;
} else {
...
var _STAR_ = (function (accum,p__32935){
var vec__32936 = p__32935;
var bit = cljs.core.nth.call(null,vec__32936,(0),null);
var protocol = cljs.core.nth.call(null,vec__32936,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__32939){
var vec__32940 = p__32939;
var ns = cljs.core.nth.call(null,vec__32940,(0),null);
var name = cljs.core.nth.call(null,vec__32940,(1),null);
var selector = cljs.core.nth.call(null,vec__32940,(2),null);
...
var post_process = (function (p__32944){
var vec__32945 = p__32944;
var munged_name = cljs.core.nth.call(null,vec__32945,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__32945,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__32943_SHARP_){
return (obj[cljs.core.first.call(null,p1__32943_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1617925391588
