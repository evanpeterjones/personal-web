...
if((i < len)){
var k = (ks[i]);
var G__9971 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__9972 = (i + (1));
m = G__9971;
i = G__9972;
continue;
...
var temp__5737__auto__ = p.argv;
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__9973 = p.children;
return reagent.impl.component.global$module$react.Children.toArray(G__9973);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__9975 = c;
var G__9975__$1 = (((G__9975 == null))?null:G__9975.prototype);
if((G__9975__$1 == null)){
return null;
} else {
return G__9975__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__9977 = c;
var G__9977__$1 = (((G__9977 == null))?null:G__9977.prototype);
if((G__9977__$1 == null)){
return null;
} else {
return G__9977__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__9981__delegate = function (args){
var G__9979 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__9979) : reagent.impl.component.as_element.call(null,G__9979));
};
...
var G__9985 = c;
var G__9985__$1 = (((G__9985 == null))?null:G__9985.constructor);
if((G__9985__$1 == null)){
return null;
} else {
return G__9985__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__9986 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__9987 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__9987);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__9986);
}});
...
var c = this;
var G__9991_9993 = goog.object.get(c,"cljsRatom");
if((G__9991_9993 == null)){
} else {
reagent.ratom.dispose_BANG_(G__9991_9993);
}
...
var renders_9994 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender], null));
var render_fun_9995 = cljs.core.first(cljs.core.vals(renders_9994));
...
if((cljs.core.count(renders_9994) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_9994))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_9995)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_9995], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__9996 = o;
goog.object.set(G__9996,cljs.core.name(k),v);
