...
if(cljs.core.truth_(((cljs.core.not(any_key))?(function (){var and__4115__auto__ = (function (){var fexpr__10571 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["",null,"_self",null], null), null);
return (fexpr__10571.cljs$core$IFn$_invoke$arity$1 ? fexpr__10571.cljs$core$IFn$_invoke$arity$1(link_target) : fexpr__10571.call(null,link_target));
})();
if(cljs.core.truth_(and__4115__auto__)){
 ...
 */
accountant.core.configure_navigation_BANG_ = (function accountant$core$configure_navigation_BANG_(p__10572){
...
var nav_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10573__$1,cljs.core.cst$kw$nav_DASH_handler);
var path_exists_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10573__$1,cljs.core.cst$kw$path_DASH_exists_QMARK_);
var reload_same_path_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10573__$1,cljs.core.cst$kw$reload_DASH_same_DASH_path_QMARK_);
...
var seq__10575 = cljs.core.seq(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [accountant.core.document_click_handler_listener_key,accountant.core.navigate_listener_key], null));
var chunk__10576 = null;
var count__10577 = (0);
var i__10578 = (0);
while(true){
if((i__10578 < count__10577)){
var key = chunk__10576.cljs$core$IIndexed$_nth$arity$2(null,i__10578);
...
var temp__5735__auto__ = cljs.core.seq(seq__10575);
if(temp__5735__auto__){
var seq__10575__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__10575__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__10575__$1);
var G__10583 = cljs.core.chunk_rest(seq__10575__$1);
var G__10584 = c__4556__auto__;
var G__10585 = cljs.core.count(c__4556__auto__);
var G__10586 = (0);
seq__10575 = G__10583;
...
var key = cljs.core.first(seq__10575__$1);
if(cljs.core.truth_(key)){
goog.events.unlistenByKey(key);
} else {
}
...
var G__10587 = cljs.core.next(seq__10575__$1);
var G__10588 = null;
var G__10589 = (0);
var G__10590 = (0);
seq__10575 = G__10587;
...
var params = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__10591_SHARP_){
return cljs.core.name(p1__10591_SHARP_);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("&",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__10592_SHARP_){
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("=",p1__10592_SHARP_);
}),pairs));
});
/**
...
if(cljs.core.truth_(accountant.core.nav_handler)){
var G__10596 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(query),cljs.core.str.cljs$core$IFn$_invoke$arity$1(hash)].join('');
return (accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1 ? accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1(G__10596) : accountant.core.nav_handler.call(null,G__10596));
} else {
