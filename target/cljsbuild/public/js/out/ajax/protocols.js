...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_39424 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_39424.call(null,this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_39425 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_39425.call(null,this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_39426 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_39426.call(null,this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_39427 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_39427.call(null,this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_39428 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_39428.call(null,this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_39429 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_39429.call(null,this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_39430 = (function (this$,header){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_39430.call(null,this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_39431 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_39431.call(null,this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_39432 = (function (this$,request){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_39432.call(null,this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_39433 = (function (this$,response){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_39433.call(null,this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k39435,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k39435,else__4383__auto__);
...
return cljs.core.reduce.call(null,(function (ret__4402__auto__,p__39440){
var vec__39441 = p__39440;
var k__4403__auto__ = cljs.core.nth.call(null,vec__39441,(0),null);
var v__4404__auto__ = cljs.core.nth.call(null,vec__39441,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this39436,other39437){
var self__ = this;
var this39436__$1 = this;
return (((!((other39437 == null)))) && ((this39436__$1.constructor === other39437.constructor)) && (cljs.core._EQ_.call(null,this39436__$1.status,other39437.status)) && (cljs.core._EQ_.call(null,this39436__$1.body,other39437.body)) && (cljs.core._EQ_.call(null,this39436__$1.status_text,other39437.status_text)) && (cljs.core._EQ_.call(null,this39436__$1.headers,other39437.headers)) && (cljs.core._EQ_.call(null,this39436__$1.was_aborted,other39437.was_aborted)) && (cljs.core._EQ_.call(null,this39436__$1.__extmap,other39437.__extmap)));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__39434){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__39444 = cljs.core.keyword_identical_QMARK_;
var expr__39445 = k__4388__auto__;
if(cljs.core.truth_(pred__39444.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__39445))){
return (new ajax.protocols.Response(G__39434,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__39444.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__39445))){
return (new ajax.protocols.Response(self__.status,G__39434,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__39444.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__39445))){
return (new ajax.protocols.Response(self__.status,self__.body,G__39434,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__39444.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__39445))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__39434,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__39444.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__39445))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__39434,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4388__auto__,G__39434),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__39434){
var self__ = this;
var this__4379__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__39434,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__39438){
var extmap__4419__auto__ = (function (){var G__39447 = cljs.core.dissoc.call(null,G__39438,new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828));
if(cljs.core.record_QMARK_.call(null,G__39438)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__39447);
} else {
return G__39447;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__39438),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__39438),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__39438),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__39438),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__39438),null,cljs.core.not_empty.call(null,extmap__4419__auto__),null));
});


//# sourceMappingURL=protocols.js.map?rel=1618065938296
